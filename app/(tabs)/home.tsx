	...
	return (
		...
		>
			<ThemedView style={styles.titleContainer}>
				<ThemedText type='title'>Matej is gay lol!</ThemedText>
				<HelloWave />
			</ThemedView>
			<ThemedView style={styles.stepContainer}>
				<ThemedText type='defaultSemiBold'>Bobek na střeše</ThemedText>
				<ThemedText type='subtitle'>sfjkdslf</ThemedText>
			</ThemedView>
			<ThemedView style={styles.stepContainer}>
